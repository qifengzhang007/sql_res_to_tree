...
//{SchoolId:2 SchoolName:第二中学(初中)            FkSchoolId:2 GradeId:5 GradeName:初二           FkGradeId:5 ClassId:4 ClassName:普通班}
//{SchoolId:2 SchoolName:第二中学(初中)            FkSchoolId:2 GradeId:6 GradeName:初三           FkGradeId:6 ClassId:5 ClassName:普通班}
//{SchoolId:2 SchoolName:第二中学(初中)            FkSchoolId:2 GradeId:6 GradeName:初三           FkGradeId:6 ClassId:5 ClassName:实验班}
